;; Handler for ADT Demographic Update
;; - A08 (Patient Demographic Update, aka, Patient Update)
;; - A31 (Person Information Update)

(ns harbinger.et.config.patient-ADT-demographic-update
